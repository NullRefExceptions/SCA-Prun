...
/* This file assists Loop Unrolling in checking whether the loop has terminated within the time and number of
iterations, it should be. It inserts call instructions in every iteration and exit blocks of the loop, which
is used to determine the termination of the loop.*/
...
CallInst *LoopUnrollTest::getTestInst(string name, Module *module)
{
