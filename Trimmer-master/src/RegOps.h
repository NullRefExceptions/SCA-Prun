...
/* This file is the main header file for RegOps. It contain methods for registers operations such 
as adding or retrieving registers. A register consists of type of the pointer value and a uint64_t 
variable, which is the location of the memory (See Mem.h) where the value pointed to is stored.
